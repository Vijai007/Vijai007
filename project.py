...
# def translate_document(text, output_file, src_lang='fr', dest_lang='en'):
#     translator = Translator()
#     translateddoc = translator.translate(text, src=src_lang, dest=dest_lang)
#     with open(output_file, 'w', encoding='utf-8') as file:
#         file.write(translateddoc.text)
...
def rag_pipeline(query, qa_chain, vectorstore, images, tables):
    ...
    log += "Relevant chunks:\n"
    for i, (doc, score) in enumerate(relevant_docs, 2):
...
def main():
    ...
    iface = gr.Interface(
        ...
        title="Web Interface for Interaction- Question Answering System",
        description="Upload data and ask questions about its content, including PDF, images,tables and SCALA logs"
    )
